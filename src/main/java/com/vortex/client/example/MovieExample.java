...
import com.vortex.client.driver.VortexClientBuilder;
...
//        String url = "https://vortexdb.live:8080";
//        String graphName = "vortex";
//        VortexClientBuilder builder = VortexClient.builder(url, graphName);
//        String trustorePath = "C:/Users/SergioManrique/Projects/VTX/vortex/config/vortexdb_live.truststore";
//        String password = "vortexdb";
//        builder.configSSL(trustorePath, password);
//        VortexClient vortexClient = builder.build();

        VortexClient vortexClient = VortexClient.builder("http://vortexdb.live:8080", "vortex").build();
